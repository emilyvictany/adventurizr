...
function CreateActivityForm() {
    ...
    return (
        ...
        <div className="w-screen">
            <h1 className="m-12 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Create an Activity!</h1>
            <div className="flex w-screen flex-row ...">
                <div>
                    <div className="place-content-start">
                        <div className="object-scale-down h-48 w-fit login100-pic js-tilt">
